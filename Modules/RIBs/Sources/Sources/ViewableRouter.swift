...
/// The base class of all routers that own view controllers, representing application states.
///
        ...
        interactable.isActivePublisher
            ...
            .sink { [weak self] isActive in
                ...
                if !isActive {
                    ...
                    viewControllerDisappearExpectation = LeakDetector.instance.expectViewControllerDisappear(viewController: viewController)
                }
