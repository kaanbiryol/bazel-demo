...
public protocol Feature {
    ...
    /// SwiftUI support - Creates a SwiftUI view for this feature
    func buildSwiftUIView(fromRoute route: Route?) -> AnyView?
...
extension Feature {
    ...
    // Default implementation returns nil - override in features that support SwiftUI
    public func buildSwiftUIView(fromRoute route: Route?) -> AnyView? { return nil }
}
